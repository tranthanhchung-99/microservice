...
public class CustomerDetailsServiceImpl implements ICustomerDetailsService {
   ...
   */
  @Override
  public CustomerdetailDto fetchDetailsCustomer(String correlationId, String mobileNumber) {
    ...
    ResponseEntity<LoansDto> loansDto = loansFeignClient.fetchLoanDetails(correlationId,
        mobileNumber);
    ResponseEntity<CardsDto> cardsDto = cardsFeignClient.fetchCardDetails(correlationId,
        mobileNumber);
